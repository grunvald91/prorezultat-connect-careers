...
const services = [
  ...
  },
  {
    ...
    description: "Стратегические и оптимизационные мероприятия для постановки целей, задач и построения системы бизнеса. Краткосрочное и долгосрочное планирование, внедрение процессов. Вывод компании из кризисной ситуации. Запуск новых продуктов на рынок или в производство",
