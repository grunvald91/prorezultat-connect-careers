          ...
          <div>
            ...
            <div className="space-y-2 text-primary-foreground/80">
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:prorezultat.info@yandex.ru" className="hover:opacity-80 transition-colors" style={{ background: 'linear-gradient(135deg, #FFD700, #FFA500)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                  prorezultat.info@yandex.ru
                </a>
              </div>
              <div className="flex items-center gap-2">
                <Phone className="w-4 h-4" />
                <a href="tel:+79998198253" className="hover:opacity-80 transition-colors" style={{ background: 'linear-gradient(135deg, #FFD700, #FFA500)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                  +7 999 819-82-53
                </a>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="text-primary-foreground/80 hover:opacity-80 transition-colors" style={{ background: 'linear-gradient(135deg, #FFD700, #FFA500)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}
              >
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-primary-foreground/60">
              <button 
                ...
                className="hover:opacity-80 transition-colors cursor-pointer" style={{ background: 'linear-gradient(135deg, #FFD700, #FFA500)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}
              >
