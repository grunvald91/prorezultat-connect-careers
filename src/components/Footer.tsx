          ...
          <div>
            ...
            <div className="space-y-2 text-primary-foreground/80">
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:prorezultat.info@yandex.ru" className="hover:opacity-80 transition-colors">
                  prorezultat.info@yandex.ru
                </a>
              </div>
              <div className="flex items-center gap-2">
                <Phone className="w-4 h-4" />
                <a href="tel:+79998198253" className="hover:opacity-80 transition-colors">
                  +7 999 819-82-53
                </a>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="text-primary-foreground/80 hover:opacity-80 transition-colors"
              >
