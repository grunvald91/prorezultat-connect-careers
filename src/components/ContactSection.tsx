          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="p-4 bg-white/60 rounded-lg backdrop-blur-sm">
                <div className="font-semibold text-foreground mb-3">Канал с HR-полезностями:</div>
                <div className="flex items-center gap-4">
                  <a 
                    href="https://t.me/prorezultat_hr" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-accent hover:text-warm-salmon transition-colors flex items-center gap-2"
                  >
                    <Send className="w-5 h-5" />
                    https://t.me/prorezultat_hr
                  </a>
                  <a 
