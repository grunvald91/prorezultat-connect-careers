          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            <div className="space-y-6">
              <div className="flex items-center gap-4 p-4 bg-white/60 rounded-lg backdrop-blur-sm">
                <Phone className="w-6 h-6 flex-shrink-0" style={{ background: 'linear-gradient(135deg, #E6C989, #D4AF37, #B8860B)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }} />
              ...
              <div className="flex items-center gap-4 p-4 bg-white/60 rounded-lg backdrop-blur-sm">
                <Mail className="w-6 h-6 flex-shrink-0" style={{ background: 'linear-gradient(135deg, #E6C989, #D4AF37, #B8860B)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }} />
                <div className="text-left">
              ...
              <div className="p-4 bg-white/60 rounded-lg backdrop-blur-sm">
                ...
                <div className="flex items-center justify-between gap-4">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    >
                      <Send className="w-8 h-8" style={{ color: '#0088cc' }} />
                    </a>
                    <a 
                      href="https://t.me/prorezultat_hr" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-sm hover:opacity-80 transition-colors" style={{ color: '#0088cc' }}
                    >
                      prorezultat_hr
                    </a>
                  </div>
                  <div className="flex flex-col items-center gap-2">
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="hover:opacity-80 transition-colors" style={{ color: '#0077ff' }}
                    >
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-sm hover:opacity-80 transition-colors" style={{ color: '#0077ff' }}
                    >
                      pro.rezultat
                    </a>
                  </div>
