          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            <div className="space-y-6">
              <div className="flex items-center gap-4 p-4 bg-white/60 rounded-lg backdrop-blur-sm">
                <Phone className="w-6 h-6 flex-shrink-0" style={{ background: 'linear-gradient(135deg, #D4AF37, #B8860B, #8B6914)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundImage: 'linear-gradient(135deg, #D4AF37, #B8860B, #8B6914)' }} />
              ...
              <div className="flex items-center gap-4 p-4 bg-white/60 rounded-lg backdrop-blur-sm">
                <Mail className="w-6 h-6 flex-shrink-0" style={{ background: 'linear-gradient(135deg, #D4AF37, #B8860B, #8B6914)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundImage: 'linear-gradient(135deg, #D4AF37, #B8860B, #8B6914)' }} />
                <div className="text-left">
              ...
              <div className="p-4 bg-white/60 rounded-lg backdrop-blur-sm">
                ...
                <div className="flex items-center justify-between gap-4">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    >
                      <Send className="w-8 h-8" style={{ background: 'linear-gradient(135deg, #D4AF37, #B8860B, #8B6914)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundImage: 'linear-gradient(135deg, #D4AF37, #B8860B, #8B6914)' }} />
                    </a>
                    <a 
                      href="https://t.me/prorezultat_hr" 
                      target="_blank" 
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="hover:opacity-80 transition-colors" style={{ background: 'linear-gradient(135deg, #D4AF37, #B8860B, #8B6914)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundImage: 'linear-gradient(135deg, #D4AF37, #B8860B, #8B6914)' }}
                    >
